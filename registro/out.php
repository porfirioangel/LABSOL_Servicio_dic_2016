...
session_cache_limiter('nocache,private');
 ...
 $p_plantel=$_SESSION['p_pla'];
 $p_nombre=$_SESSION['p_nom'];
 $p_tipo=$_SESSION['p_tipo'];
 $p_time=$_SESSION["lastoutaccess"];
 

if ($p_usuario!="" and $p_plantel!="" and $p_nombre!="" and $p_tipo!="" and $p_time!="")
{
...
session_destroy();
session_cache_limiter('nocache,private');
unset( $_SESSION['p_usu'],$_SESSION['p_pla'], $_SESSION['p_nom'],$_SESSION['p_tipo'],$_SESSION["lastoutaccess"]);
