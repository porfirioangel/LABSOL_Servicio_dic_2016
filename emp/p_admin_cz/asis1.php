...
$archivo = "asis1.php";// El nombre del archivo donde tenemos este codigo
$hasta = 10;
# <-| Opciones
$pagina = $_GET["pagina"];
if (!$pagina) {
...
$ac=" ";}
  ...
  printf("<tr class='dd' ><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td>
<td><a href=\"asis1.php?b=%s\">%s</a></td>
  <td><a href=\"asis1.php?a=%s\">%s</a></td>
  <td><a href=\"ver_mat.php?mt=%s\" target='_blank'>%s</a></td>
  </tr>",$row["matricula"], $row["nombre"]." ".$row["apellidos"], $row["institucion"],$row["email"],$ac,$row["matricula"]."&t=".$tt,"Si",$row["matricula"]."&t=".$tt,"No",$row["matricula"],"Datos",$row["matricula"]);
