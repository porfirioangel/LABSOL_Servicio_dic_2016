        ...
        <td height="30"><div align="center"><strong>Institucion</strong></div></td>
		 <td height="30"><div align="center"><strong>Email</strong></div></td>
		  ...
		  <td height="30"><div align="center"><strong>Forma de Pago</strong></div></td>
		   ...
		   <td height="30"><div align="center"><strong>Pagar</strong></div></td>
...
$row1=mysql_fetch_array($res);
  ...
  printf("<tr class='dd' ><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s<td>%s</td><td><a href=\"ver.php?mt=%s\">%s</a></td></tr>",$row["matricula"], $row["nombre"]." ".$row["apellidos"], $row["institucion"],$row["email"],fechanueva($row["fecha"]),$row1['pago'],$row1['forma_pago'],$row["matricula"],"Pagar");
