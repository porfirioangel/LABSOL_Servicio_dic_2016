            ...
            <div class="panel-group" id="accordion">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('nuevoProyecto') }}">Subir
                                            Nuevo Proyecto</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('editarProyectos') }}">Administrar
                                            Proyectos</a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('administrarEstudiantes') }}">Administrar
                                            Estudiantes</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('validarEstudiantes') }}">Validar
                                            Estudiantes</a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('consultarBecas') }}">Administrar
                                            Becas</a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div id="collapseFour" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('aprobarProyectos') }}">Aprobar
                                            Proyectos</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('avanceProyectos') }}">Avance
                                            de proyectos</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('validarTareas') }}">Validar
                                            Tareas de proyectos</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion"
                               href="#collapseInventario"><span
                                        class="glyphicon glyphicon-tag">
			                    </span> Inventario</a>
                        </h4>
                    </div>
                    <div id="collapseInventario" class="panel-collapse
                    collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('crearInventario')
                                        }}">Agregar a inventario</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <div id="collapseFive" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('nuevoAdministrador') }}">Crear
                                            Nueva cuenta</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="{{ URL::to('cuentasAdministradores') }}">Administrar
                                            Cuentas</a>
                                    </td>
                                </tr>
                            </table>
