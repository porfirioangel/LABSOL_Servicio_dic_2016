...
$link=conectarse();		
if ($_GET['b']!=""){
	mysql_query("update asistentes set activo=0 where matricula='".$_GET['b']."'" ,$link);
	
}

if ($_GET['a']!=""){
	mysql_query("update asistentes set activo=1 where matricula='".$_GET['a']."'" ,$link);
}
...
<table border="0" cellpadding="8" cellspacing="2" bordercolor="#ccc" bgcolor="#CCCCCC" >
  <tr bgcolor="#CCCCCC"  class="c">
   <td height="30"><div align="center"><strong>Id</strong></div></td>
        ...
        <td height="30"><div align="center"><strong>Institucion</strong></div></td>
		 <td height="30"><div align="center"><strong>Email</strong></div></td>
		  ...
		  <td height="30"><div align="center"><strong>Alta</strong></div></td>
		   <td height="30"><div align="center"><strong>Enviar Datos</strong></div></td>
...
$ac="baja";}else{$ac="activo";}
  ...
  printf("<tr class='dd' ><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td><a href=\"asistentes.php?b=%s\">%s</a></td><td><a href=\"asistentes.php?a=%s\">%s</a></td><td><a href=\"classes/es.php?mail=%s\">%s</a></td></tr>",$row["matricula"], $row["nombre"]." ".$row["apellidos"], $row["institucion"],$row["email"],$ac,$row["matricula"],"baja",$row["matricula"],"alta",$row["matricula"],"Enviar Datos");
