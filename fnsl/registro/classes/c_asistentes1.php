...
<br>Estaremos en contacto en los pr&#243;ximos d&#237;as.<br><br><br>Saludos!<br><br></strong><a  href='http://cozcyt.gob.mx/labsol/registro/login.php'>Iniciar Sesi&#243;n</a>";
 ...
 $mail->Host = "mail.cozcyt.gob.mx";
 $mail->From = "registro-labsol@cozcyt.gob.mx";
 $mail->FromName = utf8_decode("Laboratorio de Software Libre");
 $mail->Subject = utf8_decode("Información de su Cuenta");
 $mail->MsgHTML($body);
// $mail->AddAddress($mailerr, $nom." ".$ape);
 $mail->AddAddress($cor, utf8_decode($nom." ".$ape));
$mail->AddBCC("registro-labsol@cozcyt.gob.mx","Soporte");
//   $mail->AddBCC("contenidos@ciiti.org.mx","Contenidos");
 $mail->SMTPAuth = true;
 $mail->Username = "registro-labsol@cozcyt.gob.mx";
 $mail->Password = "p&%B$e{y3u}L"; 
