...
<div class="post" id="post-6">
  ...
  <tr>
    <td  class="ddd">|<a href="material.php">Material</a> | <a href="script.php"> Cerrar Sesion</a>|</td>
    </tr>
</table>
    <div class="postFooter">
...
$archivo = "asistentes.php";// El nombre del archivo donde tenemos este codigo
$hasta = 10;
# <-| Opciones
$pagina = $_GET["pagina"];
if (!$pagina) {
...
$resultados = mysql_query("select * from asistentes order by matricula asc");
}
...
$resultados = mysql_query('select * from asistentes order by matricula asc  '. " limit " . $desde . "," . $numpag);   //LIMIT $desde, $numpag);   //LIMIT $desde, $numpag");
}
   ...
   <td height="30"><div align="center"><strong>Matricula</strong></div></td>
        ...
        <td height="30"><div align="center"><strong>Institucion</strong></div></td>
		 <td height="30"><div align="center"><strong>Email</strong></div></td>
		  <td height="30"><div align="center"><strong>Fecha Reg.</strong></div></td>
		  	  <td height="30"><div align="center"><strong>Pago</strong></div></td>
		  <td height="30"><div align="center"><strong>Forma de Pago</strong></div></td>
	
		   <td height="30"><div align="center"><strong>Material</strong></div></td>
...
$res = mysql_query("select * from pagos where matricula=".$row['matricula']);
$row1=mysql_fetch_array($res);



  printf("<tr class='dd' ><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s<td>%s</td><td><a href=\"ver_mat.php?mt=%s\">%s</a></td></tr>",$row["matricula"], $row["nombre"]." ".$row["apellidos"], $row["institucion"],$row["email"],fechanueva($row["fecha"]),$row1['pago'],$row1['forma_pago'],$row["matricula"],"Material");
